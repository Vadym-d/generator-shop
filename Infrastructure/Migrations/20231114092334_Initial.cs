    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GeneratorCategories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GenratorCategoryId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Generators", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Generators_GeneratorCategories_GenratorCategoryId",
                        column: x => x.GenratorCategoryId,
                        principalTable: "GeneratorCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDetails_Generators_GeneratorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Generators_GenratorCategoryId",
                table: "Generators",
                column: "GenratorCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_GeneratorId",
                table: "OrderDetails",
                column: "GeneratorId");
